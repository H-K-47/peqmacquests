function event_say(e)
	...
	elseif(e.other:GetClass() == 2 and e.other:GetRace() == 6) then
		...
		elseif(e.message:findi("armguard")) then
			e.self:Say("Excellent " .. e.other:GetName() .. "! To create the correct compound in your Dark Blessed Box that will be need to be placed into a forge with this mold to craft your Initiate Darkpriest's Armguards you will need to collect and combine the following items. 3 Helms of the Lifebringer, 1 Garter Snake Tongue, 2 Ash Drakeling Scales and 2 Grapes.");
