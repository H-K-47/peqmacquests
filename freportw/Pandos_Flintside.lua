...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 13014,item2 = 13014,item3 = 13014,item4 = 13014}), false) then
		muffin = 4;
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13014,item2 = 13014,item3 = 13014}), false) then
		muffin = 3;
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13014,item2 = 13014}), false) then
		muffin = 2;
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13014}), false) then
		muffin = 1;
	end
