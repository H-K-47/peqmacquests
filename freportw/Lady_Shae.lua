...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 13031})) then
		...
		e.other:AddEXP(150);
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13030,item2 = 13030,item3 = 13030,item4 = 13030}, 0)) then
		morewine = 1;
		wine = 3;
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13030,item2 = 13030,item3 = 13030}, 0)) then
		wine = 3;
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13030,item2 = 13030}, 0)) then
		wine = 2;
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13030}, 0)) then
		wine = 1;
	end
