...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 6970,item2 = 6971,item3 = 6972}, 0)) then -- Valley Spiritling Stone, Jungle Spiritling Stone, Mountain Spiritling Stone
		...
		powders = math.random(1,4);
		e.other:SummonItem(6980,powders); -- Kejek Spirit Powder x 1 to 4 (Random)
		e.other:QuestReward(e.self,0,0,0,0,0,5000);
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 6980,item2 = 6977}, 0)) then -- Kejek Spirit Powder, Soul Orb
