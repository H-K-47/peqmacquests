...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 9031}, 0)) then
		...
		eq.unique_spawn(100019,0,0,-3711,3325,1340,0);
		e.self:Emote("Something glows brightly from high above the falls.");
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 9040}, 0)) then
		...
		e.other:QuestReward(e.self,0,0,0,0,9041);
	end
