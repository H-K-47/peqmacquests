...
function event_trade(e)
	...
	if((qglobals["shmskullquest"] ~= nil and (tonumber(qglobals["shmskullquest"] > 12))) and item_lib.check_turn_in(e.self, e.trade, {item1 = 30995, item2 = 5148})) then --Skull of Rile, Skyiron Cudgel of the Arison
