function event_say(e)
	if(e.message:findi("hail")) then
		...
		eq.pause(30);
	elseif(e.other:GetCharacterFactionLevel(342) >= 400) then
		if(e.message:findi("shield of falsehood")) then
			...
			e.other:QuestReward(e.self,0,0,0,0,1679);
		elseif(e.message:findi("last path")) then
			...
			e.other:QuestReward(e.self,0,0,0,0,1668);
		end
	end
end
...
function event_trade(e)
	...
	if(e.other:GetCharacterFactionLevel(342) >= 200) then
