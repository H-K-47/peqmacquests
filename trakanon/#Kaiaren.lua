...
function event_trade(e)
	...
	if((item_lib.check_turn_in(e.self, e.trade, {item1 = 1683})) and (e.other:GetLevel() > 45) and (" .. e.other:Class() .. "=="Monk")) then --Celestial Fists (Book)
	...
	if((item_lib.check_turn_in(e.self, e.trade, {item1 = 1684})) and (e.other:GetLevel() > 45) and (" .. e.other:Class() .. "=="Monk")) then --Charred Scale
	...
	if((item_lib.check_turn_in(e.self, e.trade, {item1 = 1688, item2 = 1689})) and (e.other:GetLevel() > 45) and (" .. e.other:Class() .. "=="Monk")) then --Demon Fangs and Book of Celestial Fists
