...
function event_trade(e)
	...
	if(e.other:GetLevel() >= 46 and e.other:GetClass() == 7) then
		if((item_lib.check_turn_in(e.self, e.trade, {item1 = 1683}))) then --Celestial Fists (Book)
		...
		if((item_lib.check_turn_in(e.self, e.trade, {item1 = 1688, item2 = 1689}))) then --Demon Fangs and Book of Celestial Fists
