function event_death_complete(e)
	...
	if(eq.get_entity_list():IsMobSpawnedByNpcTypeID(71013) 
		or eq.get_entity_list():IsMobSpawnedByNpcTypeID(71009)
		or eq.get_entity_list():IsMobSpawnedByNpcTypeID(71020)
		or eq.get_entity_list():IsMobSpawnedByNpcTypeID(71022)) then
		eq.update_spawn_timer(364318,1000); --update to respawn in 1 sec if vanquisher or guardian are still up
	end
end
