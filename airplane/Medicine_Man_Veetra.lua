function event_say(e)
	...
	elseif((e.message:findi("gina")) and (e.other:GetClass() == 10)) then
		e.self:Say("I shall summon them for you");
		eq.unique_spawn(71087,0,0,631.9,1401.9,-766.9,129.8);
		eq.depop_with_timer();
	elseif((e.message:findi("ooga")) and (e.other:GetClass() == 10)) then
		e.self:Say("I shall summon them for you");
		eq.unique_spawn(71093,0,0,653.4,1399.0,-766.9,129.8);
		eq.depop_with_timer();
	end
end
