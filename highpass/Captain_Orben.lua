...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 13792,item2 = 13792,item3 = 13792,item4 = 13792}, false)) then
			scalp = 4;
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13792,item2 = 13792,item3 = 13792}, false)) then
			scalp = 3;
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13792,item2 = 13792}, false)) then
			scalp = 2;
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13792}, false)) then
			scalp = 1;
	end
