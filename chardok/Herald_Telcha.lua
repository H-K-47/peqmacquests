...
function event_trade(e)
	...
	local salt = 0;
	local skin = 0;
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 16972, item2 = 16972, item3 = 16972, item4 = 16972}, 0)) then --  Mt. Death Mineral Salts 4x
		salt = 2;
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 16972, item2 = 16972}, 0)) then --  Mt. Death Mineral Salts 2x
		salt = 1;
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 22135,item2 = 22135, item3 = 22135, item4 = 22135}, 0)) then -- Green Goblin Skin 4x
		skin = 4;
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 22135,item2 = 22135, item3 = 22135}, 0)) then -- Green Goblin Skin 3x
		skin = 3;		
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 22135,item2 = 22135}, 0)) then -- Green Goblin Skin 2x
		skin = 2;
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 22135}, 0)) then -- Green Goblin Skin 1x
		skin = 1;
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 6476, item2 = 5728}, 0)) then -- Head of Skargus & Di'Zok Signet of Service
		...
		e.other:Faction(121,-200);
		eq.delete_global("RegalBandBathezid");
		e.other:SummonItem(5728);
		e.other:QuestReward(e.self,0,0,0,0,5727,5000); -- 5727  Regal Band of Bathezid
