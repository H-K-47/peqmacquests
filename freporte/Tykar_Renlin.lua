...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 13829,item2 = 13829,item3 = 13829,item4 = 13829}), false) then
		morechampagne = 1;
		champagne = 3;
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13829,item2 = 13829,item3 = 13829}), false) then
		champagne = 3;
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13829,item2 = 13829}), false) then
		champagne = 2;
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13829}), false) then
		champagne = 1;
	end
