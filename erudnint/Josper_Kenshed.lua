...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 13898})) then -- bag of ice necklaces
		...
		e.other:Faction(60,15,0); --faction with Crimson hands increased
		e.other:Faction(145,1,0); --faction with High Council of Erudin increased
		e.other:Faction(143,-2,0); --faction with Heretics decreased
		e.other:Faction(147,2,0); --faction with High Guards of Erudin increased
