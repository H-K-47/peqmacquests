...
function event_say(e)
	...
	elseif(e.message:findi("What Rile?") and tonumber(qglobals.shmskullquest) > 12 and e.other:GetFaction(e.self) < 6) then
	...
	elseif(e.message:findi("What emperor?") and tonumber(qglobals.shmskullquest) > 12 and e.other:GetFaction(e.self) < 6) then
	...
	elseif(e.message:findi("What others?") and tonumber(qglobals.shmskullquest) > 12 and e.other:GetFaction(e.self) < 6) then
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 30989}) and e.other:GetFaction(e.self) < 6 and tonumber(qglobals.shmskullquest) > 12) then
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 30991, item2 = 30990, item3 = 30993, item4 = 30992}) and e.other:GetFaction(e.self) < 6 and tonumber(qglobals.shmskullquest) > 12) then
