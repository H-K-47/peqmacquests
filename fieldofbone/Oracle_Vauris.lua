...
function event_say(e)
	...
	elseif(e.message:findi("rile") and e.other:GetFaction(e.self) < 6) then
	...
	elseif((e.message:findi("emperor") or e.message:findi("xalgoz")) and e.other:GetFaction(e.self) < 6) then
	...
	elseif(e.message:findi("other") and e.other:GetFaction(e.self) < 6) then
...
function event_trade(e)
	...
	if(e.other:GetFaction(e.self) < 6) then
		...
		if(item_lib.check_turn_in(e.self, e.trade, {item1 = 30991, item2 = 30990, item3 = 30993, item4 = 30992})) then
