...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 18054}) and e.other:GetFaction(e.self) < 6) then
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 12735, item2 = 5142}) and e.other:GetFaction(e.self) < 6) then
