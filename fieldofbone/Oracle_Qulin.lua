...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 30984}) and e.other:GetFaction(e.self) < 6 and tonumber(qglobals.shmskullquest) > 9) then
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 30985}) and e.other:GetFaction(e.self) < 6 and tonumber(qglobals.shmskullquest) > 9) then
