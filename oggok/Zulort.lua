...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 13187, item2 = 13187, item3 = 13187, item4 = 13187})) then
		...
		e.other:Faction(295, 5);
		e.other:QuestReward(e.self,0,0,0,0,15093,500);
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 14199, item2 = 13367, item3 = 13367, item4 = 13367})) then
