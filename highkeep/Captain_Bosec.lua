...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 13790,item2 = 13790,item3 = 13790,item4 = 13790}, false)) then
			ear = 4;
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13790,item2 = 13790,item3 = 13790}, false)) then
			ear = 3;
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13790,item2 = 13790}, false)) then
			ear = 2;
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13790}, false)) then
			ear = 1;
	end
