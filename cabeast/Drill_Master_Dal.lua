...
function event_trade(e)
	...
	if(e.other:GetFaction(e.self) < 5) then
		if(item_lib.check_turn_in(e.self, e.trade, {item1 = 12915, item2 = 12915, item3 = 12915, item4 = 12915})) then
			...
			e.other:Ding();
		elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 12673})) then
