function event_say(e)
	...
	elseif(e.message:findi("Sisters of Scale") and faction < 6) then
	...
	elseif(e.message:findi("What memory of Sebilis?")) then
		e.self:Emote("takes a sip of Legion Lager.");
		e.self:Say("Puhh...lease!! That's the little trophy the War Baron brought back from Sebilis. He got it stolen from him by some thieves!! I say it was the [Steelhead gang]. They were waltzing in and out of Cabilis like it was a blasted public vomitorium!!");
	elseif(e.message:findi("What steelhead gang?")) then
		e.self:Emote("picks some flesh from between his teeth.");
		e.self:Say("The Steelhead gang were a band of Forsaken thieves. No one knew this!! They used to walk around here like they were rebirthed!! They used to frequent my place and get involved in head butt contests. Whew!! I tell ya, the only way to crack their skulls is with a forging hammer!! Heheh!!");
	end
end
