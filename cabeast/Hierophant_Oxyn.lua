...
function event_say(e)
	...
	elseif((e.message:findi("iron cudgel")) and (e.other:GetFaction(e.self) < 3)) then
	...
	elseif((e.message:findi("other skulls")) and (e.other:GetFaction(e.self) <= 4)) then
	...
	elseif((e.message:findi("damaged")) and (e.other:GetFaction(e.self) <= 4)) then
