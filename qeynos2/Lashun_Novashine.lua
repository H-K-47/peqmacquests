...
function event_trade(e)
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13073,item2 = 13073,item3 = 13073}, 0)) then
		number_of_bone_chip = 3;	
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13073,item2 = 13073}, 0)) then
		number_of_bone_chip = 2;	
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13073}, 0)) then
		number_of_bone_chip = 1;
	elseif(item_lib.check_turn_in(e.self, e.trade, {gold = 2}, 0)) then
		number_of_bone_chip = 1;
		two_gold = 1;
	end
