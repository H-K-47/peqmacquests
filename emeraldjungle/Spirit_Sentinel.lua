...
function event_say(e)
	...
	if(e.other:GetFaction(e.self) <= 3) then
		if(e.other:GetCharacterFactionLevel(342) >= 500) then
		...
		if(e.other:GetCharacterFactionLevel(342) >= 600) then
...
function event_trade(e)
	...
	if(e.other:GetFaction(e.self) <= 3) then
		if(item_lib.check_turn_in(e.self, e.trade, {item1 = 1668})) then --Part of Shaman Epic 1.0
			if(e.other:GetCharacterFactionLevel(342) >= 400) then
