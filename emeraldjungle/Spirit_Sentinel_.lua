...
function event_say(e)
	...
	elseif((e.message:findi("breach")) and (qglobals["ShmEpic1"] == 1)) then --Part of Shaman Epic 1.0
...
function event_trade(e)
	...
	if(e.other:GetFaction(e.self) <= 2) then
		...
		elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 18459})) then --Part of Shaman Epic 1.0
			...
			e.other:Faction(342,50);
			e.other:QuestReward(e.self,0,0,0,0,0,100000);
		elseif((e.other:GetFaction(e.self)==1) and item_lib.check_turn_in(e.self, e.trade, {item1 = 1674})) then --Part of Shaman Epic 1.0
