...
function event_say(e)
	...
	elseif(e.message:findi("black hole")) then --Part of Shaman Epic 1.0
	...
	if(e.other:GetFaction(e.self) <= 2) then
		...
		elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 18459})) then --Part of Shaman Epic 1.0
			if(e.other:GetCharacterFactionLevel(342) >= 1000) then
				...
				e.other:Faction(342,1000);
				e.other:QuestReward(e.self,0,0,0,0,0,75000);
			else
				e.self:Say("You need to prove your dedication to our cause before I can discuss such matters with you.");
				e.other:SummonItem(18459);
			end				
		elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 1674})) then --Part of Shaman Epic 1.0
			if(e.other:GetCharacterFactionLevel(342) >= 2000) then
				...
				e.other:Faction(342,-2000);
				e.other:QuestReward(e.self,0,0,0,0,10651,75000);
			else
				e.self:Say("You need to prove your dedication to our cause before I can discuss such matters with you.");
				e.other:SummonItem(1674);
			end	
		end
	end
