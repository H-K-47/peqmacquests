...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 13034, item2 = 13034, item3 = 13034, item4 = 13034}), false) then
		brandy = 4;
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13034, item2 = 13034, item3 = 13034}), false) then	
		brandy = 3;
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13034, item2 = 13034}), false) then
		brandy = 2;
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13034}), false) then
		brandy = 1;
	end
