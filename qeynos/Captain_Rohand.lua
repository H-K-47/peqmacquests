function event_say(e)
	...
	elseif(e.message:findi("odus") or e.message:findi("faydwer") or e.message:findi("kunark")) then
			if(e.other:GetFaction(e.self) > 4) then -- confirmed live requires faction
				local reply = eq.ChooseRandom(1,2,3,4);
