...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 13033, item2 = 13033, item3 = 13033, item4 = 13033}), false) then
		moredrinks = 4;
		drinks = 3;
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13033, item2 = 13033, item3 = 13033}), false) then
		drinks = 3;
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13033, item2 = 13033}), false) then
		drinks = 2;
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13033}), false) then
		drinks = 1;
	end
	if(drinks > 0) then
		repeat
