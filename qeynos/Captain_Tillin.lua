...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 13915, item2 = 13915, item3 = 13915, item4 = 13915}, false)) then -- Gnoll Fang
		fang = 4;
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13915, item2 = 13915, item3 = 13915}, false)) then	
		fang = 3;
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13915, item2 = 13915}, false)) then
		fang = 2;
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13915}, false)) then
		fang = 1;
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 18815}, false)) then
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 18912}, false)) then
