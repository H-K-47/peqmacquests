...
function event_trade(e)
	...
	--Heal (Light Healing)
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 12739, item2 = 12739})) then--2x Brittle Iksar Skull
	...
	--Cure Poison
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 12441})) then--Watcher Signal Torch
