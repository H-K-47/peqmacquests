...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 18099}) and charfaction >= 7) then
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 14365}) and charfaction >= 14) then
		...
		e.other:Faction(342,7);
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 14382}) and charfaction >= 21) then
		...
		e.other:Faction(342,7);
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 5403,item2 = 11609,item3 = 5430,item4 = 14366}) and charfaction >= 35) then
