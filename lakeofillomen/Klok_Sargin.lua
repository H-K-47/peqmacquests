...
function event_say(e)
	if(e.message:findi("I am looking for a skull of the Sisters of Scale") and e.other:GetFaction(e.self) <= 5) then
	...
	elseif(e.message:findi("what slight favor") and e.other:GetFaction(e.self) <= 5) then
...
function event_trade(e)
	...
	if(e.other:GetFaction(e.self) < 6) then
		if(item_lib.check_turn_in(e.self, e.trade, {item1 = 12761})) then
